...
export WANDB_NAME=llava-178k-youtube-qwen-vl-max-CoT-Qwen2-VL-7B
# export WANDB_MODE=offlinew

# You can use 2B instead of 7B
# MODEL_NAME="Qwen/Qwen2-VL-7B-Instruct"
# MODEL_NAME="Qwen/Qwen2-VL-2B-Instruct"
MODEL_NAME="/root/models/Qwen2-VL-7B-Instruct"
...
deepspeed src/training/train.py \
    ...
    --model_id $MODEL_NAME \
    --data_path /root/Open-R1-Video-V1/data/LLaVA-Video-2_3_m_youtube_mc-qwen_filter_1.json \
