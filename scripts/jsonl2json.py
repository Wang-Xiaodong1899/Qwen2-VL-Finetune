...
jsonl_file = "/root/Open-R1-Video-V1/data/qwen-debate-hound-17k/qwen-hound-17k-0520_total_merge-rej.jsonl"  # 输入的JSONL文件路径
json_file = "/root/Open-R1-Video-V1/data/qwen-debate-hound-17k/qwen-hound-17k-0520_total_merge-rej-add_videotok-17k.json"   # 输出的JSON文件路径
jsonl_to_json_with_video_tag(jsonl_file, json_file)