...
export WANDB_PROJECT=Qwen3-VL-8B-Video-LeanPO-real

export FPS_MAX_FRAMES=32

export WANDB_NAME=hound-17k-first-round-5e-7-ep2-t1-f${FPS_MAX_FRAMES}-inject-real-temp1-1112
...
deepspeed src/train/train_leanpo.py \
    ...
    --model_id $MODEL_NAME \
    --data_path /mnt/bn/wxd-video-understanding/wangxd/Qwen3VL-Video-GRPO/Qwen2-VL-Finetune/data/qwen-hound-17k-inject-temp1-1112/merged_data.json \
