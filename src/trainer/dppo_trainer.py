...
# from trl import DPPOTrainer
from trl.trainer.dppo_trainer import DPPOTrainer
...
class QwenDPPOTrainer(DPPOTrainer):

    def __init__(self, processing_class, *args, **kwargs):
        super(QwenDPPOTrainer, self).__init__(processing_class=processing_class, *args, **kwargs)
    ...
    def concatenated_inputs(
        ...
        concatenated_batch['chosen_score'] = batch["chosen_score"]
        concatenated_batch['rejected_score'] = batch["rejected_score"]
    ...
    def concatenated_forward(self, model: nn.Module, batch: dict[str, Union[list, torch.LongTensor]], is_ref_model: bool = False):
        ...
        output["chosen_score"] = concatenated_batch["chosen_score"]
        output["rejected_score"] = concatenated_batch["rejected_score"]
    ...
    def _save_checkpoint(self, model, trial):
        if self.args.lora_enable:
            ...
            super(QwenDPPOTrainer, self)._save_checkpoint(model, trial)