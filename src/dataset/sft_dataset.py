...
from .data_utils import get_image_info, get_video_info, llava_to_openai, pad_sequence, get_video_list_info

class SupervisedDataset4Frames(Dataset):
    ...
    def __init__(
        ...
        super(SupervisedDataset4Frames, self).__init__()
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "image" in sources:
            ...
            for video_file in video_files:
                ...
                video_input, video_kwargs = get_video_list_info(
                    video_file, 
...
def make_supervised_data_module(model_id, processor, data_args):
    ...
    # )
    sft_dataset = SupervisedDataset4Frames(
        data_path=data_args.data_path, processor=processor, data_args=data_args, model_id=model_id
    )
    eval_dataset = None
